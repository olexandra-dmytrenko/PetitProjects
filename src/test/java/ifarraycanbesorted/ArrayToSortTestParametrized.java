...
public class ArrayToSortTestParametrized {
    ...
    public static Iterable<Object[]> data() {
        Object[] params1 = new Object[]{Boolean.TRUE, new int[]{1, 3, 2}};
        Object[] params2 = new Object[]{Boolean.TRUE, new int[]{1, 3, 2, 2}};
        Object[] params3 = new Object[]{Boolean.TRUE, new int[]{2, 1, 3}};
